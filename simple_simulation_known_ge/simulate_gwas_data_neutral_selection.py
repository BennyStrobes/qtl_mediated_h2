...
gene_causal_effects[np.random.choice(np.arange(n_genes), size=n_causal_genes, replace=False)] = np.random.normal(loc=0.0, scale=np.sqrt(per_element_heritability/.05),size=n_causal_genes)
