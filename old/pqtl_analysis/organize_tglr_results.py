...
def extract_expression_mediated_h2(jacknifed_taus, eqtl_start_index, m_vec):
	...
	mean_expr_med_h2 = np.mean(jacknifed_expr_h2)

	diff = jacknifed_expr_h2 - mean_expr_med_h2
	num_jacknife_samples = jacknifed_expr_h2.shape[0]
...
def extract_non_mediated_h2(jacknifed_taus, eqtl_start_index, m_vec):
	jacknifed_med_h2 = jacknifed_taus*m_vec


	jacknifed_geno_h2 = np.sum(jacknifed_med_h2[:,:eqtl_start_index],axis=1)

	mean_expr_med_h2 = np.mean(jacknifed_geno_h2)

	diff = jacknifed_geno_h2 - mean_expr_med_h2
	num_jacknife_samples = jacknifed_geno_h2.shape[0]
...
def extract_fraction_expression_mediated_h2(jacknifed_taus, eqtl_start_index, m_vec):
	jacknifed_med_h2 = jacknifed_taus*m_vec
...
print_organized_summary_file(tglr_output_stem + '_per_annotation_h2s.txt', joint_anno_names, tau*m_vec, tau_se*m_vec)
print_organized_summary_file(tglr_output_stem + '_per_annotation_h2s_5_50.txt', joint_anno_names, tau*m_5_50_vec, tau_se*m_5_50_vec)
...
# Frac mediated 
frac_h2_med, frac_h2_med_se = extract_fraction_expression_mediated_h2(jacknifed_taus, eqtl_start_index, m_vec)
frac_h2_5_50_med, frac_h2_5_50_med_se = extract_fraction_expression_mediated_h2(jacknifed_taus, eqtl_start_index, m_5_50_vec)
print_organized_h2_mediated(tglr_output_stem + '_frac_h2_med.txt', frac_h2_med, frac_h2_med_se)
print_organized_h2_mediated(tglr_output_stem + '_frac_h2_med_5_50.txt', frac_h2_5_50_med, frac_h2_5_50_med_se)

# Mediated h2 est
h2_med, h2_med_se = extract_expression_mediated_h2(jacknifed_taus, eqtl_start_index, m_vec)
h2_med_5_50, h2_med_5_50_se = extract_expression_mediated_h2(jacknifed_taus, eqtl_start_index, m_5_50_vec)
print_organized_h2_mediated(tglr_output_stem + '_h2_med.txt', h2_med, h2_med_se)
print_organized_h2_mediated(tglr_output_stem + '_h2_med_5_50.txt', h2_med_5_50, h2_med_5_50_se)

# Non-mediated h2 est
h2_nonmed, h2_nonmed_se = extract_non_mediated_h2(jacknifed_taus, eqtl_start_index, m_vec)
h2_nonmed_5_50, h2_nonmed_5_50_se = extract_non_mediated_h2(jacknifed_taus, eqtl_start_index, m_5_50_vec)
print_organized_h2_mediated(tglr_output_stem + '_h2_nonmed.txt', h2_nonmed, h2_nonmed_se)
print_organized_h2_mediated(tglr_output_stem + '_h2_nonmed_5_50.txt', h2_nonmed_5_50, h2_nonmed_5_50_se)
