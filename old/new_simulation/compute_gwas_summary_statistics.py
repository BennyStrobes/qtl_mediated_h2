...
# Load in trait data
trait_values_file = simulated_gwas_data_dir + simulation_name_string + 'simulated_trait.txt'
trait_vector = load_in_trait_vec(trait_values_file)


# Compute GWAS summary statistics
gwas_output_file = simulated_gwas_data_dir + simulation_name_string + 'simulated_gwas_summary_stats.txt'
