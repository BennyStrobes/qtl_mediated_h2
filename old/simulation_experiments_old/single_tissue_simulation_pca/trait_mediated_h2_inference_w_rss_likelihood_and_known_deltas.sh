...
python3 trait_mediated_h2_inference_w_rss_likelihood_and_known_deltas.py $simulation_number $simulation_name_string $simulated_trait_dir $simulated_gwas_dir $simulation_genotype_dir $simulated_learned_gene_models_dir $n_gwas_individuals $eqtl_sample_size $trait_med_h2_inference_dir $resid_var_bool $simulated_gene_expression_dir
