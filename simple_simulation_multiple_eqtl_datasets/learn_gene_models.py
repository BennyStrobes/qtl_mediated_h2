...
eqtl_dataset_iter = int(sys.argv[8])
...
expression_file = simulated_expression_data_dir + simulation_name_string + 'eqtl_ss_' + str(eqtl_ss) + '_eqtl_dataset_' + str(eqtl_dataset_iter) + '.npy'
gene_expression = np.load(expression_file)
# load in genetic gene expression
genetic_expression_file = simulated_expression_data_dir + simulation_name_string + 'eqtl_ss_' + str(eqtl_ss)+ '_eqtl_dataset_' + str(eqtl_dataset_iter) + '_genetic_ge.npy'
...
prediction_blup_related_snp_anno_vec = np.zeros(n_snps)
...
for line in f:
	...
	# Get BLUP Prediction
	#################
	gene_prediction_gene_related_snp_anno_blup = get_genes_posterior_on_gene_related_snp_anno(eqtl_posterior_mean_blup, 0.0*eqtl_posterior_var_blup, LD, gene_snp_indices)
	prediction_blup_related_snp_anno_vec = prediction_blup_related_snp_anno_vec + gene_prediction_gene_related_snp_anno_blup
...
genetic_ge_marginal_beta_file = simulated_gene_models_dir + simulation_name_string + 'estimated_genetic_ge_eqtl_marginal_beta_' + str(eqtl_ss)+ '_eqtl_dataset_' + str(eqtl_dataset_iter) + '.npy'
np.save(genetic_ge_marginal_beta_file, marginal_beta_genetic_ge_vec)

# Save estimated noisy gene related snp annotations
est_noisy_gene_related_snp_anno_file = simulated_gene_models_dir + simulation_name_string + 'estimated_noisy_gene_related_snp_annotations_' + str(eqtl_ss)+ '_eqtl_dataset_' + str(eqtl_dataset_iter) + '.npy'
...
est_noisy_gene_related_snp_anno_noise_file = simulated_gene_models_dir + simulation_name_string + 'estimated_noisy_gene_related_snp_annotation_noises_' + str(eqtl_ss)+ '_eqtl_dataset_' + str(eqtl_dataset_iter) + '.npy'
...
posterior_known_h2_known_resid_var_gene_related_snp_anno_file = simulated_gene_models_dir + simulation_name_string + 'posterior_known_h2_known_resid_var_gene_related_snp_annotations_' + str(eqtl_ss)+ '_eqtl_dataset_' + str(eqtl_dataset_iter) + '.npy'
...
posterior_blup_gene_related_snp_anno_file = simulated_gene_models_dir + simulation_name_string + 'posterior_blup_gene_related_snp_annotations_' + str(eqtl_ss)+ '_eqtl_dataset_' + str(eqtl_dataset_iter) + '.npy'
np.save(posterior_blup_gene_related_snp_anno_file, posterior_blup_related_snp_anno_vec)

# Save prediction estimated gene related snp annotation noises (BLUP)
prediction_blup_gene_related_snp_anno_file = simulated_gene_models_dir + simulation_name_string + 'prediction_blup_gene_related_snp_annotations_' + str(eqtl_ss)+ '_eqtl_dataset_' + str(eqtl_dataset_iter) + '.npy'
np.save(prediction_blup_gene_related_snp_anno_file, prediction_blup_related_snp_anno_vec)

# Save estimated gene h2 (unknown gene h2, unknown resid var)
est_gene_h2_unknown_h2_unknown_resid_var_file = simulated_gene_models_dir + simulation_name_string + 'est_gene_h2_unknown_h2_unknown_resid_var_' + str(eqtl_ss)+ '_eqtl_dataset_' + str(eqtl_dataset_iter) + '.npy'
np.save(est_gene_h2_unknown_h2_unknown_resid_var_file, est_gene_h2)


# Save estimated gene h2 (BLUP PVES)
est_gene_h2_blup_file = simulated_gene_models_dir + simulation_name_string + 'est_gene_h2_blup_' + str(eqtl_ss)+ '_eqtl_dataset_' + str(eqtl_dataset_iter) + '.npy'
