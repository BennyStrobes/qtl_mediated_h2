...
def simulate_data(gwas_ss, n_snps, eqtl_ss_1, eqtl_ss_2, eqtl_ss_3, med_h2_1, med_h2_2, med_h2_3, ge_h2_1, ge_h2_2, ge_h2_3):
	...
	return sim_alpha_1, sim_alpha_2, sim_alpha_3, Y, E_1, E_2, E_3, gwas_geno, eqtl_geno_1, eqtl_geno_2, eqtl_geno_3
...
def scipy_odr_mediated_effect_est(gwas_beta, gene_betas, eqtl_sss, gwas_ss):
	...
	odr_obj = odr.ODR(data, linear, maxit=10000, beta0=[0.0, 0.0, 0.0])
	output = odr_obj.run()

	if output.stopreason[0] != 'Sum of squares convergence':
...
for sim_iter in range(n_sims):
	...
	# First simulate data
	sim_alpha_1, sim_alpha_2, sim_alpha_3, Y, E_1, E_2, E_3, Y_geno, E_1_geno, E_2_geno, E_3_geno = simulate_data(gwas_ss, n_snps, eqtl_ss_1, eqtl_ss_2, eqtl_ss_3, med_h2_1, med_h2_2, med_h2_3, ge_h2_1, ge_h2_2, ge_h2_3)
	...
	# Optimize fxn
	est_alphas, est_delta = scipy_odr_mediated_effect_est(gwas_beta, gene_betas, eqtl_sss, gwas_ss)
