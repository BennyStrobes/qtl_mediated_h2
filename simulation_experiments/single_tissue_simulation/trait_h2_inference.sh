...
python3 trait_h2_inference.py $simulation_number $simulation_name_string $simulated_trait_dir $simulated_gwas_dir $n_gwas_individuals $trait_h2_inference_dir
