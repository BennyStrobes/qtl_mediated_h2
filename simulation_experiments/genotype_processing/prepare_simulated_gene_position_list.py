...
cis_window_size = int(sys.argv[4])
...
t.write('gene_name\tchrom\ttss\ttes\tcis_window_start\tcis_window_end\n')
counter = 0
for line in f:
	...
	gene_start = int(tss) - cis_window_size
	gene_end = int(tss) + cis_window_size


	t.write(chrom_num + '\t' + ensamble_id + '\t' + tss + '\t' + tes + '\t' + str(gene_start) + '\t' + str(gene_end) + '\n')
