...
do
	...
	output_stem=${trait_med_h2_inference_dir}${simulation_name_string}"_"${eqtl_snp_representation}"_"${non_med_anno}"_"${simulated_gt_architecture}"_"${inference_gt_architecture}"_"${eqtl_sample_size}"_TMP"
	echo $non_med_anno"_"$eqtl_snp_representation"_"$eqtl_sample_size
	python3 ${joint_ldsc_code_dir}run_joint_ldsc.py \
		--gwas-sumstat-file $gwas_sumstat_file \
		--gwas-N ${n_gwas_individuals} \
...
do
	...
	output_stem=${trait_med_h2_inference_dir}${simulation_name_string}"_"${eqtl_snp_representation}"_"${non_med_anno}"_"${simulated_gt_architecture}"_"${inference_gt_architecture}"-per_dataset_var_"${eqtl_sample_size}
	echo $non_med_anno"_"$eqtl_snp_representation"_"$eqtl_sample_size
	python3 ${joint_ldsc_code_dir}run_joint_ldsc.py \
		--gwas-sumstat-file $gwas_sumstat_file \
		--gwas-N ${n_gwas_individuals} \
