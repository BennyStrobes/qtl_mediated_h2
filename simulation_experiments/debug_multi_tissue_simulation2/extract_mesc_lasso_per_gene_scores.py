...
for tissue_iter in range(5):
	for replicate_name in ['replicate1', 'replicate2']:
		for eqtl_ss in eqtl_ss_arr:
			...
			output_file = tissue_sumstat1_output_file = mesc_expression_score_dir + simulation_name_string + '_tissue' + str(tissue_iter) + '_' + str(eqtl_ss) + '_' + replicate_name + '_mesc_lasso_pred_eqtl_sumstats.txt'
