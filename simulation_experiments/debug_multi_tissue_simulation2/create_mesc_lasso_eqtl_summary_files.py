...
for eqtl_ss in eqtl_sss:
	...
	output_file = mesc_expression_score_dir + simulation_name_string + '_' + eqtl_ss + '_' + 'mesc_lasso_corr_replicate_eqtl_sumstats_xt_summary.txt'
	generate_xt_eqtl_summary_file(mesc_expression_score_dir,simulation_name_string, eqtl_ss, 'mesc_lasso', output_file)

	output_file = mesc_expression_score_dir + simulation_name_string + '_' + eqtl_ss + '_' + 'mesc_lasso_corr_standardized_replicate_eqtl_sumstats_xt_summary.txt'
	generate_xt_eqtl_summary_file(mesc_expression_score_dir,simulation_name_string, eqtl_ss, 'mesc_lasso_standardized', output_file)
