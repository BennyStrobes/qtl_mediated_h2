...
def create_mapping_from_simulation_number_to_simulated_heritabilities(simulated_trait_dir, tmp_simulation_name_string, sim_nums, inference_gt_architecture, invalid_sims):
	mapping = {}
	for sim_number in sim_nums:
		if sim_number in invalid_sims:
			continue
...
sim_heritabilities = create_mapping_from_simulation_number_to_simulated_heritabilities(simulated_trait_dir, tmp_simulation_name_string, sim_nums, simulated_gt_architecture, invalid_sims)
