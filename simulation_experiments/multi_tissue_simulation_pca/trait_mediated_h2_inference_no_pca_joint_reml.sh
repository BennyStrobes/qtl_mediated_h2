...
#SBATCH -t 0-9:25                         # Runtime in D-HH:MM format
...
do
	...
	date
	python3 trait_mediated_h2_inference_no_pca_joint_reml.py $simulation_number $simulation_name_string $simulated_trait_dir $simulated_gwas_dir $simulation_genotype_dir $simulated_learned_gene_models_dir $n_gwas_individuals $eqtl_sample_size $trait_med_h2_inference_dir
	date
done
date
