...
def load_in_eqtl_data3(eqtl_sumstat_file, snp_name_to_position, window_name_to_ld_files, eqtl_sample_size, num_snps, alt_simulated_learned_gene_models_dir, simulation_name_string, eqtl_ld='out_of_sample', ldsc_variance=False, single_tissue=False):
	# First get list of gene names
	gene_names = []
	gene_classes = []
	f = open(eqtl_sumstat_file)
	...
	for gg_iter, gene_name in enumerate(gene_names):
		...
		if ldsc_variance:
			gene_model = gene_model*np.sqrt(gene_ldsc_h2)/np.sqrt(gene_var)
			gene_var = np.dot(np.dot(gene_model, small_ld_mat), gene_model)
...
eqtl_ld_scores, n_genes, gene_cis_h2 = load_in_eqtl_data3(eqtl_sumstat_file, snp_name_to_position, window_to_ld_files ,eqtl_sample_size, len(gwas_rsids), alt_simulated_learned_gene_models_dir, simulation_name_string, eqtl_ld='out_of_sample', ldsc_variance=False)
...
# Out of sample eqtl ld
eqtl_sumstat_file = simulated_learned_gene_models_dir + simulation_name_string + '_' + str(eqtl_sample_size) + '_small_window_eqtl_sumstats.txt'
eqtl_ld_scores, n_genes, gene_cis_h2 = load_in_eqtl_data3(eqtl_sumstat_file, snp_name_to_position, window_to_ld_files ,eqtl_sample_size, len(gwas_rsids), alt_simulated_learned_gene_models_dir, simulation_name_string, eqtl_ld='out_of_sample', ldsc_variance=True)
...
eqtl_ld_scores, n_genes, gene_cis_h2 = load_in_eqtl_data3(eqtl_sumstat_file, snp_name_to_position, window_to_ld_files ,eqtl_sample_size, len(gwas_rsids), alt_simulated_learned_gene_models_dir, perm_simulation_name_string, eqtl_ld='out_of_sample', ldsc_variance=False)
...
perm_simulation_name_string = 'simulation_' + str(int(simulation_number)+1) + '_chrom' + simulation_name_string.split('_chrom')[1]
eqtl_sumstat_file = simulated_learned_gene_models_dir + perm_simulation_name_string + '_' + str(eqtl_sample_size) + '_small_window_eqtl_sumstats.txt'
eqtl_ld_scores, n_genes, gene_cis_h2 = load_in_eqtl_data3(eqtl_sumstat_file, snp_name_to_position, window_to_ld_files ,eqtl_sample_size, len(gwas_rsids), alt_simulated_learned_gene_models_dir, perm_simulation_name_string, eqtl_ld='out_of_sample', ldsc_variance=True)
